        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input readonly="" type="text" class="form-control" id="ledger_code" name="ledger_code" placeholder="Subsidiary Ledger Code" value="{{$subsidiaryLedger->ledger_code}}">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input required="" type="text" class="form-control" id="ledger_head" name="ledger_head" placeholder="Enter Subsidiary Ledger Name" value="{{$subsidiaryLedger->ledger_head}}">
                </div>
            </div>          
