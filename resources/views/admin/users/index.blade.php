      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card bg-dark">
            ...
            <div class="card">
            <div class="card-header"><div style="display:inline-block; padding-top:5px;"><i class="fa fa-table"></i> User List </div> <button type="button" class="btn btn-dark btn-sm waves-effect waves-light pull-right" id="addNew"> <i class="fa fa-plus"></i> <span>Add New</span></button></div>
