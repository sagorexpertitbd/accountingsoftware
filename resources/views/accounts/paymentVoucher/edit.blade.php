...
<form action="{{route('Accounts.payment_voucher.update', $voucher->id)}}" method="put">
    @csrf
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input type="text" class="form-control" id="trans_date" name="trans_date" placeholder="Payment Date" required="" value="{{$tran_date}}">
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label required" for="sl_id">Subsidiary Ledger</label>
                    <div class="col-md-8 col-sm-12">
                    ...
                    <tbody id="selected_account">
                        ...
                        @forelse($voucherDtl as $voucherDtl)
                            <tr class="tran_dtl">
                                ...
                                <td>{{$voucherDtl->drSlHead}}<input type="hidden" name="sl_id[]" value="{{$voucherDtl->dr_sub_ledger}}"></td>
                                <td>{{$voucherDtl->crSlHead}}<input type="hidden" name="trans_by[]" value="{{$voucherDtl->cr_sub_ledger}}"></td>
