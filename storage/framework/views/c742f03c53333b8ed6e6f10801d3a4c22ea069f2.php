<?php $__env->startSection('title', 'Income Statement - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-12" id="report-template">
        <div class="card">
          <div class="card-header text-uppercase"> <i class="fa fa-eye"></i> Income Statement</div>
            <div class="card-body">
  ...
  $(document).ready(function(){
    ...
    $("#report-btn").click(function(e){
      ...
      if(!from_date) {
        ...
        $.ajax({
          url: '<?php echo e(route("Accounts.incomeStatement")); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\WAMPP\www\SOFTWARE\ACC-SOFTWARE-GHANA\resources\views/accounts/reports/incomeStatement/template.blade.php ENDPATH**/ ?>