<select class="form-control select2" id="sl_id" name="sl_id">
    <option value=""><?php echo e($gl_id>0 ? ('All Subsidiary Ledger of '.$gl_name) : 'Select Subsidiary Ledger'); ?></option>
...
</script><?php /**PATH N:\WAMPP\www\SOFTWARE\ACC-SOFTWARE-GHANA\resources\views/accounts/reports/ledgerReport/gl_slLedger.blade.php ENDPATH**/ ?>