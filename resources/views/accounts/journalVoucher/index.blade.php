...
@section('title', 'Journal Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.'')
        ...
        <div class="col-lg-12">
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-share"></i><span> Journal Voucher</span>
            </div>
            ...
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Journal Voucher List
              </div>
...
@if($set_currency->currency_position==2){{$set_currency->symbol}}@endif 
  ...
  @section('js')
    ...
    $(document).ready(function() {
        dataTableLoad({
            curUrl: "{{route('Accounts.journal_voucher.index')}}",
            addUrl: "{{route('Accounts.journal_voucher.create')}}"
        });
    });
    </script>
  @endsection