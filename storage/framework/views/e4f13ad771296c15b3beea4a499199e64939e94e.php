...
<div id="tab1">
<h5 class="company_name"><?php echo e($company_name); ?></h5>
...
<table class="responsive table table-bordered">
  <thead>
    <tr>
      ...
      <?php endif; ?>
      <th width="8%" class="text-center bg-light_2">Date</th>
      <th width="7%" class="text-center bg-light_2">Voucher</th>
      <th class="bg-light_2">Particulars</th>
      <th class="bg-light_2">Remarks</th>
      <th width="14%" class="text-right bg-light_2">Debit</th>
      <th width="14%" class="text-right bg-light_2">Credit</th>
      <th width="14%" class="text-right bg-light_2">Balance</th>
    </tr>
  </thead>
  <tbody>
<?php
...
</div><?php /**PATH N:\WAMPP\www\SOFTWARE\ACC-SOFTWARE-GHANA\resources\views/accounts/reports/ledgerReport/report.blade.php ENDPATH**/ ?>