...
@section('title', 'Contra Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.'')
        ...
        <div class="col-lg-12">
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-share"></i><span> Contra Voucher</span>
            </div>
            ...
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Contra Voucher List
              </div>
