...
@section('title', 'Payment Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.'')
...
<div class="clearfix"></div>
  ...
  @section('js')
    ...
    $(document).ready(function() {
        dataTableLoad({
            curUrl: "{{route('Accounts.payment_voucher.index')}}",
            addUrl: "{{route('Accounts.payment_voucher.create')}}"
        });
    });
    </script>
  @endsection