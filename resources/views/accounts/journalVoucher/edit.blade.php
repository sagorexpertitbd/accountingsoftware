...
<form action="{{route('Accounts.journal_voucher.update', $voucher->id)}}" method="put">
    @csrf
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label" for="voucher_no">Voucher No</label>
                ...
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label" for="total_amount">Total Amount</label>
                    <div class="col-md-8 col-sm-12">
                        <input readonly="" type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Total Amount" value="{{$voucher->transaction_amount}}">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label required" for="trans_date">Date</label>
                    <div class="col-md-8 col-sm-12">
                        <input type="text" class="form-control" id="trans_date" name="trans_date" placeholder="Date" required="" value="{{$tran_date}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label" for="remarks">Remarks</label>
                    <div class="col-md-8 col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="form-group row">
                    <label class="col-md-4 col-sm-12 control-label required" for="amount">Amount</label>
                    <div class="col-md-8 col-sm-12">
            ...
            <div class="col-md-4 col-sm-12">
                <button type="button" class="btn btn-dark btn-sm" id="addTran"><i class="fa fa-plus"></i> Add Transaction</button>
            </div>
        </div>
        <hr style="margin:-.2rem 0 0.7rem 0;">
        <div class="row">
            <div class="col-sm-12">
                <table class="responsive table table-striped table-bordered" cellspacing="0">
                    <thead>
                        <tr>
                            <th width="4%">No.</th>
                            <th>Debit Subsidiary Ledger</th>
                            <th>Credit Subsidiary Ledger</th>
...
$(document).ready(function() {
    ...
    $("#addTran").click(function(e){
        ...
        if(!dr_sl_id) {
            alert("Please Select Debit Subsidiary Ledger");
        } else if(!cr_sl_id) {
            alert("Please Select Credit Subsidiary Ledger");
        } else if(!amount) {
