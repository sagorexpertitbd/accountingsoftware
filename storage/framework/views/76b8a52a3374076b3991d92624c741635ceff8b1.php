<?php $__env->startSection('title', 'Payment Voucher - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<div class="clearfix"></div>
        ...
        <div class="col-lg-12">
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-share"></i><span> Payment Voucher</span>
            </div>
            ...
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Payment Voucher List
              </div> 
  ...
  <?php $__env->startSection('js'); ?>
    ...
    $(document).ready(function() {
        dataTableLoad({
            curUrl: "<?php echo e(route('Accounts.payment_voucher.index')); ?>",
            addUrl: "<?php echo e(route('Accounts.payment_voucher.create')); ?>"
        });
    });
    </script>
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\WAMPP\www\SOFTWARE\ACC-SOFTWARE-GHANA\resources\views/accounts/paymentVoucher/index.blade.php ENDPATH**/ ?>