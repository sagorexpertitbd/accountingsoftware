...
<form action="{{route('Accounts.journal_voucher.store')}}" method="post">
    @csrf
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <input readonly="" type="text" class="form-control" id="total_amount" name="total_amount" placeholder="Total Amount">
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
