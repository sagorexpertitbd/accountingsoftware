<?php $__env->startSection('title', 'Trial Balance - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
  ...
  $(document).ready(function(){
    ...
    $("#report-btn").click(function(e){
      ...
      if(!date) {
        ...
        $.ajax({
          url: '<?php echo e(route("Accounts.trialBalance")); ?>',
          data: {date: date},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\WAMPP\www\SOFTWARE\ACC-SOFTWARE-GHANA\resources\views/accounts/reports/trialBalance/template.blade.php ENDPATH**/ ?>