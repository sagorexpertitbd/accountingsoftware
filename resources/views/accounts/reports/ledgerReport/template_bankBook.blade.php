...
@section('title', 'Bank Book - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.'')
    ...
    $("#report-btn").click(function(e){
      ...
      if(!from_date) {
        ...
        $.ajax({
          ...
          data: {report_type: 3, gl_id: '{{$gl_id}}', sl_id: sl_id, from_date: from_date, to_date: to_date},
