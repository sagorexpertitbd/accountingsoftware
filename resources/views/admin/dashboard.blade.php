...
<div class="clearfix"></div>
      ...
      <div class="card-group">
         <div class="card bg-dark border-right border-secondary-light">
            <div class="card-header bg-transparent text-white">
               <i class="fa fa-indent" aria-hidden="true"></i> Admin Dashboard
            </div>
          </div>
      </div>
  ...
  <script src="{{ asset('/expert/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js') }}"></script>
  <script src="{{ asset('/expert/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
  <!-- Sparkline JS -->
  <script src="{{ asset('/expert/assets/plugins/sparkline-charts/jquery.sparkline.min.js') }}"></script>
  <!-- Chart js -->
  ...
  <!-- Index js -->
  <script src="{{ asset('/expert/assets/js/index3.js') }}"></script>
  @endsection